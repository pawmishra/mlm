      ...
      <div class='panel-body col-xs-12'>
        <form class='form-horizontal' role='form'>
          ...
          <div class='form-group'>
            <label class='control-label col-md-2 col-md-offset-2' for='id_checkin'>Month</label>
            <div class='col-md-8'>
              <div class='col-md-3'>
          ...
          <div class='form-group'>
            <label class='control-label col-md-3 col-md-offset-2' for='id_email'>Search By Keyword </label>
            <div class='col-md-6'>
              <div class='form-group'>
                <div class='col-md-11'>
          ...
          <div class='form-group'>
            <label class='control-label col-md-3 col-md-offset-2' for='id_accomodation'>Pin Issue By</label>
            <div class='col-md-4'>
