        ...
        <form class='form-horizontal' role='form'>
          ...
          <div class='form-group'>            
            <div class='col-md-offset-4 col-md-3'>
              <button class='btn-lg btn-danger' style='float:right' type='submit'>Show</button>
            </div>
          </div>
           <h3>
          ...
          <div class='form-group'>
            <label class='control-label col-md-3 col-md-offset-2' for='id_email'>Enter UserID </label>
            <div class='col-md-6'>
              <div class='form-group'>
                <div class='col-md-11'>
