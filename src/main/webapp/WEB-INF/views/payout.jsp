			...
			<section class="content">
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="box">
							...
							<div class="box-body">
								...
								<table class="display dataTable no-footer" border="1"
									...
									<thead>
										<tr
											style="background-color: yellowgreen; text-align: center; color: white"
											role="row">
						...
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">Survey Income</h3>
							</div>
							<!-- /.box-header -->
							<div class="box-body ">
								<!-- <table id="tbl_data1" class="table table-striped table-bordered"
									style="width: 100%"> -->
								<table class="display dataTable no-footer" border="1"
									style="width: 100%;" id="tbl_data" role="grid"
									aria-describedby="tbl_data_info">
