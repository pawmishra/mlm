				...
				<div class="col-xs-12">
						...
						<div class="box-header">
							<div class="container">
								...
								<div class="row">
									...
									<form:form  action="save_document_question"
											method="POST" modelAttribute="documentQuestions">
											<div class="form-row">
												
												<div class="form-group col-md-6">
													<label for="question">Question:</label>
													<form:textarea class="form-control" id="questions"
														aria-label="With textarea" name="question"
														path="question" required="required" />
					...
					<div class="box-body">
						...
						<table class="display dataTable no-footer" border="1"
							...
							<tbody>
								<c:forEach items="${listOfdocumentQuestions}" var="question">
    								<tr>
										<td>${question.id}</td>
