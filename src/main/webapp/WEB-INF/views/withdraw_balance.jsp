									       ...
									       <form>
									          ...
									          <div class="form-row">
												    <div class="form-group col-md-6">
												      ...
												      <input type="text" class="form-control" id="organizationname" readonly="readonly" name="walletbalance" placeholder="Wallet Balance">
												    </div>
													 <div class="form-group col-md-6">
												      <label for="organizationname">Withdraw Amount:</label>
												      <input type="text" class="form-control" id="organizationname" name="withdraw_amount" placeholder="Withdraw Amount">
												    </div>
									          </div>
