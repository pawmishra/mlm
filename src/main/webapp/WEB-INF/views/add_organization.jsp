									       ...
									       <form>
									          ...
									          <div class="form-row">
												    <div class="form-group col-md-6">
												      ...
												      <input type="text" class="form-control" id="organizationname" name="organization_name" placeholder="Organization Name">
												    </div>
									...
									<thead>
										<tr
											...
											<th class="sorting_desc" tabindex="0"
												...
												style="width: 32px;" aria-sort="descending">Organization Name</th>
