    ...
    <div class="wrapper">
      ...
      <div class='panel-body col-xs-12'>
        <form class='form-horizontal' role='form'>
          <h1>
           ...
           <div class='form-group'>
            ...
            <div class='col-md-6'>
              <div class='form-group'>
                <div class='col-md-11'>
                  <input class='form-control' id='id_email' placeholder='Select Member ID' type='text'>
                </div>                 
              </div>
            </div>
          </div>
          ...
          <div class='form-group'>
            <label class='control-label col-md-3 col-md-offset-2' for='id_email'>Mobile</label>
            <div class='col-md-6'>
              <div class='form-group'>
                <div class='col-md-11'>
                  <input class='form-control' id='id_email' placeholder='Mobile' type='text'>
                </div>
              </div>
              </div>
          </div>      
          <div class='form-group'>
            ...
            <div class='col-md-6'>
              <div class='form-group'>
                <div class='col-md-11'>
                  <input class='form-control' id='id_email' placeholder='Joining' type='text'>
                </div>
              </div>
              </div>
          </div>  
           <div class='form-group'>
            <label class='control-label col-md-3 col-md-offset-2' for='id_accomodation'>Package</label>
            <div class='col-md-4'>
             ...
             <div class='form-group'>
            <label class='control-label col-md-3 col-md-offset-2' for='id_email'>Points </label>
            <div class='col-md-6'>
              <div class='form-group'>
                <div class='col-md-11'>
          ...
          <div class='form-group'>
            <label class='control-label col-md-3 col-md-offset-2' for='id_email'>Capping </label>
            <div class='col-md-6'>
              <div class='form-group'>
                <div class='col-md-11'>
                  <input class='form-control' id='id_email' placeholder='Capping' type='text'>
                </div>
              </div>
            </div>
          </div>
