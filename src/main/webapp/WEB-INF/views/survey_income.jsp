	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>Income generated from reviewing projects</h1>
				<ol class="breadcrumb">
									...
									<thead>
										<tr
											...
											<th class="sorting_desc" tabindex="0"
												...
												style="width: 32px;" aria-sort="descending">Transaction Remark</th>
											<th class="sorting_desc" tabindex="0"
												aria-controls="tbl_data" rowspan="1" colspan="1"
												aria-label="Position: activate to sort column ascending"
												style="width: 32px;" aria-sort="descending">Document Reviewed</th>
											<th class="sorting_desc" tabindex="0"
												aria-controls="tbl_data" rowspan="1" colspan="1"
												aria-label="Office: activate to sort column ascending"
												style="width: 32px;" aria-sort="descending">Transaction Date</th>
												
											<th class="sorting_desc" tabindex="0"
												aria-controls="tbl_data" rowspan="1" colspan="1"
												aria-label="Office: activate to sort column ascending"
												style="width: 32px;" aria-sort="descending">Amount Credited</th>
								
										</tr>
									</thead>
									<tbody>
									<c:forEach items="${listOfSurveyIncome}" var="item">
										<tr>
