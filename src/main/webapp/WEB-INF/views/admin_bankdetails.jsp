...
<body class="skin-blue">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>Members Bank Details</h1>
			<ol class="breadcrumb">
				<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
				<li><a href="#">Dashboard</a></li>
				<li class="active">Members Bank Details</li>
			</ol>
			</section>
					...
					<div class="box">
						...
						<div class="box-body">
							...
							<table class="display dataTable no-footer" border="1"
								...
								<thead>
									<tr
										...
										<th class="sorting_desc" tabindex="0" aria-controls="tbl_data"
											...
											style="width: 32px;" aria-sort="descending">Bank Name</th>
										<th class="sorting_desc" tabindex="0" aria-controls="tbl_data"
											rowspan="1" colspan="1"
											aria-label="Age: activate to sort column ascending"
											style="width: 32px;" aria-sort="descending">Bank Branch</th>
										<th class="sorting_desc" tabindex="0" aria-controls="tbl_data"
											rowspan="1" colspan="1"
											aria-label="Start date: activate to sort column ascending"
											style="width: 32px;" aria-sort="descending">Account Number</th>
										<th class="sorting_desc" tabindex="0" aria-controls="tbl_data"
											rowspan="1" colspan="1"
											aria-label="Salary: activate to sort column ascending"
											style="width: 32px;" aria-sort="descending">IFSC Code</th>
										<th class="sorting_desc" tabindex="0" aria-controls="tbl_data"
											rowspan="1" colspan="1"
											aria-label="Salary: activate to sort column ascending"
											style="width: 32px;" aria-sort="descending">Mobile Number</th>
										<th class="sorting_desc" tabindex="0" aria-controls="tbl_data"
											rowspan="1" colspan="1"
											aria-label="Salary: activate to sort column ascending"
								...
								<tbody>
									<c:forEach items="${listOfBankDetails}" var="item">
										<tr>
											<td>${item.bank_id}</td>
